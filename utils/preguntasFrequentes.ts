...
//   {
//     pregunta: '¿Qué es Manteniendo a las Familias Unidas?',
//     respuesta: 'Manteniendo a las Familias Unidas es un proceso que permite que ciertos no ciudadanos que son cónyuges o hijastros de ciudadanos estadounidenses soliciten el permiso de permanencia temporal en el país (conocido en inglés como “parole in place”) que les permite solicitar el estatus de residente permanente legal sin tener que estar separados de sus familias al salir de Estados Unidos para el procesamiento. El permiso de permanencia temporal en el país es un ejercicio de la autoridad discrecional de DHS bajo la sección 212 (d)(5)(A) de la Ley de Inmigración y Nacionalidad (INA) para permitir que ciertos “solicitantes de admisión” no ciudadanos estén presentes en Estados Unidos de manera temporal, caso por caso, por razones humanitarias urgentes o de beneficio público significativo. La INA define a un “solicitante de admisión”, en la parte pertinente, como un no ciudadano “presente en Estados Unidos que no ha sido admitido”. Los no ciudadanos que ingresaron a Estados Unidos sin haber sido admitidos o haber recibido un permiso de permanencia temporal pueden solicitar el permiso de permanencia temporal en el país porque siguen siendo “solicitantes de admisión”. Aquellas personas que reciben el permiso de permanencia temporal en el país son elegibles para una autorización de empleo por el tiempo de duración del permiso de permanencia temporal en el país.'
//   },
//   {
//     pregunta: 'Qué formulario debo presentar para presentar una petición para el proceso Manteniendo a las Familias Unidas? ¿Puedo presentar la solicitud en línea?',
//     respuesta: 'R. Los solicitantes (el cónyuge o hijastro no ciudadano) deben presentar el Formulario I-131F, Solicitud de Permiso de Permanencia Temporal para Ciertos Cónyuges e Hijastros de Ciudadanos Estadounidenses no Ciudadanos, bajo este proceso. El formulario solo se puede presentar en línea. Las peticiones en formato impreso que sean enviadas a USCIS por correo serán rechazadas (no aceptadas ni se emitirá un recibo). Hemos creado una Guía para Presentación del Formulario I-131F (PDF, 8.95 MB) para ayudar a las personas a prepararse para presentar una petición de permiso de permanencia temporal en el país a través de este proceso en línea.'
//   },
//   {
//     pregunta: 'Si se me concede mi petición bajo Manteniendo a las Familias Unida, ¿cuánto durará mi permiso de permanencia temporal en el país?',
//     respuesta: 'En general, si se le otorga un permiso de permanencia temporal en el país como cónyuge no ciudadano o hijastro no ciudadano de un ciudadano estadounidense, el período del permiso de permanencia temporal en el país será válido a partir de la fecha en que USCIS apruebe su Formulario I-131F y expirará tres (3) años a partir de esa fecha. Sin embargo, el permiso de permanencia temporal se cancelará automáticamente si usted sale de Estados Unidos. El permiso de permanencia temporal también puede cancelarse en cualquier momento a discreción de DHS tras la determinación de que el permiso de permanencia temporal ya no está justificado, por ejemplo, después de la comisión de una conducta delictiva.Siempre que su permiso de permanencia temporal continúe válido (lo que significa que no haya caducado o se haya cancelado), se considerará que usted está en un periodo de estadía autorizada. En calidad de persona con permiso de permanencia temporal (lo que se conoce como “parolee” en inglés), usted puede solicitar cualquier estatus de inmigración para el que pueda ser elegible, incluido el ajuste de estatus al de un residente permanente legal.'
//   },

//   {
//     pregunta: '¿Cuáles son los criterios de elegibilidad para el proceso Manteniendo a las Familias Unidas?',
//     respuesta: 'Para ser considerado en este proceso como cónyuge o hijastro no ciudadano de un ciudadano estadounidense, debe estar presente en EE. UU. sin admisión ni permiso de permanencia temporal. Los cónyuges deben haber estado en EE. UU. desde junio de 2014 y estar casados legalmente antes de junio de 2024. Los hijastros deben ser menores de 21 años y solteros antes de junio de 2024, y su padre/madre no ciudadano debe haberse casado con un ciudadano estadounidense antes de su cumpleaños 18. Tanto cónyuges como hijastros deben no tener antecedentes penales, cumplir con requisitos de seguridad y presentar datos biométricos para la verificación de antecedentes.'
//   },

//   {
//     pregunta: ' ¿Cómo puedo presentar una petición bajo Manteniendo a las Familias?',
