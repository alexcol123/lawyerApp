...
const CallToAction = () => {
  return (
    <div className=" flex flex-col w-full p-6 border rounded-xl bg-primary/10  ">
      ...
      <p className="text-base  tracking-tight mt-2  ">
        Si estás en EE.UU y casado con un ciudadano Americano, y entraste de manera ilegal, calificas pare este programa,  para que no tengas que salir de  EE.UU,  y puedas aplicar a la recidencia. Infórmate ahora
      </p>
    </div>
  )
}
